...
public class QuantityMesurmentTest
{
    ...
    public void given0FeetAnd0Feet_shouldReturnEqual() {
        QuantityMesurement length = new QuantityMesurement(QuantityMesurement.UnitConversion.FEET,0.0);
        QuantityMesurement length1 = new QuantityMesurement(QuantityMesurement.UnitConversion.FEET,0.0);
    ...
    {
        QuantityMesurement length = new QuantityMesurement(QuantityMesurement.UnitConversion.FEET,0.0);
        QuantityMesurement length1 = new QuantityMesurement(QuantityMesurement.UnitConversion.FEET,1.0);
        boolean eq= length.equals(length1);
    ...
    {
        QuantityMesurement length = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,0.0);
        QuantityMesurement length1 = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,0.0);
        Assert.assertEquals(length,length1); //
    }
    @Test
    public void given0inchAnd1inch_shouldReturnNot_Equal()
    { QuantityMesurement length = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,0.0);
      QuantityMesurement length1 = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,1.0);
        Assert.assertNotEquals(length,length1);
    }

    @Test
    public void given1feetand_1inch_Shouldreturn_NOTEQUAL()
    { QuantityMesurement length = new QuantityMesurement(QuantityMesurement.UnitConversion.FEET,1.0);
      QuantityMesurement length1 = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,1.0);
        Assert.assertNotEquals(length,length1);
    }
    ...
    public void whenWeCheck12InchIsEqTo1Feet() {
      QuantityMesurement length = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,12.0);
      QuantityMesurement length1 = new QuantityMesurement(QuantityMesurement.UnitConversion.FEET,1.0);
        boolean comparecheck=length.compare(length1);
    ...
    public void whenWeCompare3FeetEqToOneYardreturnsTRUE() {
       QuantityMesurement length = new QuantityMesurement(QuantityMesurement.UnitConversion.FEET,3.0);
       QuantityMesurement length1 = new QuantityMesurement(QuantityMesurement.UnitConversion.YARD,1.0);
        boolean comparecheck=length.compare(length1);   //
        Assert.assertTrue(comparecheck);
    }
    @Test
    ...
    public void whenWeCompare1Inch_notEqTo_OneYardreturnsFALSE() {
      QuantityMesurement length = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,1.0);
      QuantityMesurement length1 = new QuantityMesurement(QuantityMesurement.UnitConversion.YARD,1.0);
        boolean comparecheck=length.compare(length1);
        Assert.assertFalse(comparecheck);
    }
    ...
    public void whenWeCompare1Yard_EqTo_36inch_returnstrue() {
       QuantityMesurement length = new QuantityMesurement(QuantityMesurement.UnitConversion.YARD,1.0);
       QuantityMesurement length1 = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,36.0);
        boolean comparecheck=length.compare(length1);
        Assert.assertFalse(comparecheck);
    }
    @Test
    public void whenWeCompare36Inch_EqTo_1Yard_returnstrue() {
        QuantityMesurement length = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,36.0);
        QuantityMesurement length1 = new QuantityMesurement(QuantityMesurement.UnitConversion.YARD,1.0);
        boolean comparecheck=length.compare(length1);
        Assert.assertFalse(comparecheck);
    }
    ...
    public void whenWeCompare1Yard_EqTo_3feet_returnstrue() {
       QuantityMesurement length = new QuantityMesurement(QuantityMesurement.UnitConversion.YARD,1.0);
       QuantityMesurement length1 = new QuantityMesurement(QuantityMesurement.UnitConversion.FEET,3.0);
        boolean comparecheck=length.compare(length1);
        Assert.assertFalse(comparecheck);
    }
    ...
    public void whenWeCompare2inch_5cm_returnTrue() {
       QuantityMesurement smallestUnit = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,2.0);
       QuantityMesurement smallestUnitq1 = new QuantityMesurement(QuantityMesurement.UnitConversion.CENTIMETER,5.0);
    ...
    {
        QuantityMesurement smallestUnit = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,2.0);
        QuantityMesurement smallestUnitq1 = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,2.0);
    ...
    {
         QuantityMesurement smallestUnit = new QuantityMesurement(QuantityMesurement.UnitConversion.FEET,1.0);
         QuantityMesurement smallestUnitq1 = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,2.0);
         double sum= QuantityMesurement.add(smallestUnit,smallestUnitq1);
    ...
    {
       QuantityMesurement smallestUnit = new QuantityMesurement(QuantityMesurement.UnitConversion.FEET,1.0);
       QuantityMesurement smallestUnitq1 = new QuantityMesurement(QuantityMesurement.UnitConversion.FEET,1.0);
       double sum= QuantityMesurement.add(smallestUnit,smallestUnitq1);
    ...
    {
       QuantityMesurement smallestUnit = new QuantityMesurement(QuantityMesurement.UnitConversion.INCH,2.5);
       QuantityMesurement smallestUnitq1 = new QuantityMesurement(QuantityMesurement.UnitConversion.CENTIMETER,3.0);
       double sum= QuantityMesurement.add(smallestUnit,smallestUnitq1);
    ...
    {
        QuantityMesurement quantityMesurement = new QuantityMesurement(QuantityMesurement.UnitConversion.TONES,1.0);
...
//    {
//        QuantityMesurement quantityMesurement = new QuantityMesurement(QuantityMesurement.UnitConversion.FAHRENHEIT,212.0);
//        QuantityMesurement quantityMesurement1 = new QuantityMesurement(QuantityMesurement.UnitConversion.CELSIUS,100.00);
//        boolean comparecheck= quantityMesurement.compare(quantityMesurement1);
//        Assert.assertTrue(comparecheck);
//    }
